            ...
            .data =
                {
                    add(
                        ...
                        add(
                        {
                            ...
                            .init = Registers{.si = 0x04, .bp = 0x80},
                            .expect =
                                Registers{.si = 0x04, .bp = 0x80, .ip = 2, .es = 0x1234},
                            .cycles        = 0x11,
                        }),
                        add(
                        {
                            .cmd  = {0x8c, 0x03},
                            .memop= MemoryOp{.address = 0x84, .data = {0x34, 0x12}},
                            .init = Registers{.di = 0x04, .bp = 0x80},
                            .expect =
                                Registers{.di = 0x04, .bp = 0x80, .ip = 2, .es = 0x1234},
                            .cycles        = 0x10,
                        }),
                        add(
                        {
                        ...
                        add(
                        {
                            ...
                            .memop= MemoryOp{.address = 0x2010, .data = {0x34, 0x12}},
                            .init = Registers{},
                            .expect =
                    ...
                    add(
                        {
                            ...
                            .init = Registers{.bx = 0x80, .si = 0x04},
                            .expect =
                                Registers{.bx = 0x80, .si = 0x04, .ip = 2, .cs = 0x1234},
                            .cycles        = 0x10,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.bx = 0x80, .di = 0x04},
                            .expect =
                                Registers{.bx = 0x80, .di = 0x04, .ip = 2, .cs = 0x1234},
                            .cycles        = 0x11,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.si = 0x04, .bp = 0x80},
                            .expect =
                                Registers{.si = 0x04, .bp = 0x80, .ip = 2, .cs = 0x1234},
                            .cycles        = 0x11,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.di = 0x04, .bp = 0x80},
                            .expect =
                                Registers{.di = 0x04, .bp = 0x80, .ip = 2, .cs = 0x1234},
                            .cycles        = 0x10,
                        }),
                        add(
                        {
                    ...
                    add(
                        {
                            ...
                            .init = Registers{.bx = 0x80, .si = 0x04},
                            .expect =
                                Registers{.bx = 0x80, .si = 0x04, .ip = 2, .ss = 0x1234},
                            .cycles        = 0x10,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.bx = 0x80, .di = 0x04},
                            .expect =
                                Registers{.bx = 0x80, .di = 0x04, .ip = 2, .ss = 0x1234},
                            .cycles        = 0x11,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.si = 0x04, .bp = 0x80},
                            .expect =
                                Registers{.si = 0x04, .bp = 0x80, .ip = 2, .ss = 0x1234},
                            .cycles        = 0x11,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.di = 0x04, .bp = 0x80},
                            .expect =
                                Registers{.di = 0x04, .bp = 0x80, .ip = 2, .ss = 0x1234},
                            .cycles        = 0x10,
                        }),
                        add(
                        {
                    ...
                    add(
                        ...
                        add(
                        {
                            ...
                            .init = Registers{.bx = 0x80, .di = 0x04},
                            .expect =
                                Registers{.bx = 0x80, .di = 0x04, .ip = 2, .ds = 0x1234},
                            .cycles        = 0x11,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.si = 0x04, .bp = 0x80},
                            .expect =
                                Registers{.si = 0x04, .bp = 0x80, .ip = 2, .ds = 0x1234},
                            .cycles        = 0x11,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.di = 0x04, .bp = 0x80},
                            .expect =
                                Registers{.di = 0x04, .bp = 0x80, .ip = 2, .ds = 0x1234},
                            .cycles        = 0x10,
                        }),
                        add(
                        {
...
/////////////////////////////////////////////////
                    add(
                        {
                            .cmd  = {0x8c, 0x40, 0x10},
                            .memop= MemoryOp{.address = 0x94, .data = {0x34, 0x12}},
                            .init = Registers{.bx = 0x80, .si = 0x04},
                            .expect =
                                Registers{.bx = 0x80, .si = 0x04, .ip = 3, .es = 0x1234},
                            .cycles        = 0x14,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.bx = 0x80, .di = 0x04},
                            .expect =
                                Registers{.bx = 0x80, .di = 0x04, .ip = 3, .es = 0x1234},
                            .cycles        = 0x15,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.si = 0x04, .bp = 0x80},
                            .expect =
                                Registers{.si = 0x04, .bp = 0x80, .ip = 3, .es = 0x1234},
                            .cycles        = 0x15,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.di = 0x04, .bp = 0x80},
                            .expect =
                                Registers{.di = 0x04, .bp = 0x80, .ip = 3, .es = 0x1234},
                            .cycles        = 0x14,
                        }),
                        add(
                        {
                        ...
                        {
                            .cmd  = {0x8c, 0x46, 0x10},
                            .memop= MemoryOp{.address = 0x2020, .data = {0x34, 0x12}},
                            .init = Registers{.bp = 0x2010},
                            .expect =
                    ...
                    add(
                        {
                            ...
                            .init = Registers{.bx = 0x80, .si = 0x04},
                            .expect =
                                Registers{.bx = 0x80, .si = 0x04, .ip = 3, .cs = 0x1234},
                            .cycles        = 0x14,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.bx = 0x80, .di = 0x04},
                            .expect =
                                Registers{.bx = 0x80, .di = 0x04, .ip = 3, .cs = 0x1234},
                            .cycles        = 0x15,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.si = 0x04, .bp = 0x80},
                            .expect =
                                Registers{.si = 0x04, .bp = 0x80, .ip = 3, .cs = 0x1234},
                            .cycles        = 0x15,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.di = 0x04, .bp = 0x80},
                            .expect =
                                Registers{.di = 0x04, .bp = 0x80, .ip = 3, .cs = 0x1234},
                            .cycles        = 0x14,
                        }),
                        add(
                        {
                    ...
                    add(
                        {
                            ...
                            .init = Registers{.bx = 0x80, .si = 0x04},
                            .expect =
                                Registers{.bx = 0x80, .si = 0x04, .ip = 3, .ss = 0x1234},
                            .cycles        = 0x14,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.bx = 0x80, .di = 0x04},
                            .expect =
                                Registers{.bx = 0x80, .di = 0x04, .ip = 3, .ss = 0x1234},
                            .cycles        = 0x15,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.si = 0x04, .bp = 0x80},
                            .expect =
                                Registers{.si = 0x04, .bp = 0x80, .ip = 3, .ss = 0x1234},
                            .cycles        = 0x15,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.di = 0x04, .bp = 0x80},
                            .expect =
                                Registers{.di = 0x04, .bp = 0x80, .ip = 3, .ss = 0x1234},
                            .cycles        = 0x14,
                        }),
                        add(
                        {
                    ...
                    add(
                        {
                            ...
                            .init = Registers{.bx = 0x80, .si = 0x04},
                            .expect =
                                Registers{.bx = 0x80, .si = 0x04, .ip = 3, .ds = 0x1234},
                            .cycles        = 0x14,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.bx = 0x80, .di = 0x04},
                            .expect =
                                Registers{.bx = 0x80, .di = 0x04, .ip = 3, .ds = 0x1234},
                            .cycles        = 0x15,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.si = 0x04, .bp = 0x80},
                            .expect =
                                Registers{.si = 0x04, .bp = 0x80, .ip = 3, .ds = 0x1234},
                            .cycles        = 0x15,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.di = 0x04, .bp = 0x80},
                            .expect =
                                Registers{.di = 0x04, .bp = 0x80, .ip = 3, .ds = 0x1234},
                            .cycles        = 0x14,
                        }),
                        add(
                        {
                    ...
                    add(
                        {
                            ...
                            .memop= MemoryOp{.address = 0x2094, .data = {0x34, 0x12}},
                            .init = Registers{.bx = 0x80, .si = 0x04},
                            .expect =
                                Registers{.bx = 0x80, .si = 0x04, .ip = 4, .es = 0x1234},
                            .cycles        = 0x14,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.bx = 0x80, .di = 0x04},
                            .expect =
                                Registers{.bx = 0x80, .di = 0x04, .ip = 4, .es = 0x1234},
                            .cycles        = 0x15,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.si = 0x04, .bp = 0x80},
                            .expect =
                                Registers{.si = 0x04, .bp = 0x80, .ip = 4, .es = 0x1234},
                            .cycles        = 0x15,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.di = 0x04, .bp = 0x80},
                            .expect =
                                Registers{.di = 0x04, .bp = 0x80, .ip = 4, .es = 0x1234},
                            .cycles        = 0x14,
                        }),
                        add(
                        {
                        ...
                        add(
                        {
                            ...
                            .memop= MemoryOp{.address = 0x4020, .data = {0x34, 0x12}},
                            .init = Registers{.bp = 0x2010},
                            .expect =
                    ...
                    add(
                        {
                            ...
                            .init = Registers{.bx = 0x80, .si = 0x04},
                            .expect =
                                Registers{.bx = 0x80, .si = 0x04, .ip = 4, .cs = 0x1234},
                            .cycles        = 0x14,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.bx = 0x80, .di = 0x04},
                            .expect =
                                Registers{.bx = 0x80, .di = 0x04, .ip = 4, .cs = 0x1234},
                            .cycles        = 0x15,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.si = 0x04, .bp = 0x80},
                            .expect =
                                Registers{.si = 0x04, .bp = 0x80, .ip = 4, .cs = 0x1234},
                            .cycles        = 0x15,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.di = 0x04, .bp = 0x80},
                            .expect =
                                Registers{.di = 0x04, .bp = 0x80, .ip = 4, .cs = 0x1234},
                            .cycles        = 0x14,
                        }),
                        add(
                        {
                    ...
                    add(
                        {
                            ...
                            .init = Registers{.bx = 0x80, .si = 0x04},
                            .expect =
                                Registers{.bx = 0x80, .si = 0x04, .ip = 4, .ss = 0x1234},
                            .cycles        = 0x14,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.bx = 0x80, .di = 0x04},
                            .expect =
                                Registers{.bx = 0x80, .di = 0x04, .ip = 4, .ss = 0x1234},
                            .cycles        = 0x15,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.si = 0x04, .bp = 0x80},
                            .expect =
                                Registers{.si = 0x04, .bp = 0x80, .ip = 4, .ss = 0x1234},
                            .cycles        = 0x15,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.di = 0x04, .bp = 0x80},
                            .expect =
                                Registers{.di = 0x04, .bp = 0x80, .ip = 4, .ss = 0x1234},
                            .cycles        = 0x14,
                        }),
                        add(
                        {
                    ...
                    add(
                        {
                            ...
                            .init = Registers{.bx = 0x80, .si = 0x04},
                            .expect =
                                Registers{.bx = 0x80, .si = 0x04, .ip = 4, .ds = 0x1234},
                            .cycles        = 0x14,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.bx = 0x80, .di = 0x04},
                            .expect =
                                Registers{.bx = 0x80, .di = 0x04, .ip = 4, .ds = 0x1234},
                            .cycles        = 0x15,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.si = 0x04, .bp = 0x80},
                            .expect =
                                Registers{.si = 0x04, .bp = 0x80, .ip = 4, .ds = 0x1234},
                            .cycles        = 0x15,
                        }),
                        add(
                        {
                            ...
                            .init = Registers{.di = 0x04, .bp = 0x80},
                            .expect =
                                Registers{.di = 0x04, .bp = 0x80, .ip = 4, .ds = 0x1234},
                            .cycles        = 0x14,
                        }),
                        add(
                        {
        ...
        MovFromMemToRegParams{
            ...
            .data = {
                add({
                    ...
                    .expect =
                        Registers{.bx = 0x80, .si = 0x04, .ip = 2, .es = 0x1234},
                    .expect_memory = MemoryOp{.address = 0x84, .data = {0x34, 0x12}},
                    .cycles        = 0x10,
                }),
                add({
                    .cmd  = {0x8e, 0x01},
                ...
                add({
                    ...
                    .expect =
                        Registers{.ip = 4, .es = 0x1234},
                    .expect_memory = MemoryOp{.address = 0x801, .data = {0x34, 0x12}},
                    .cycles        = 0x0f,
                }),
                add({
                    .cmd  = {0x8e, 0x07}, 
                ...
                add({
                    ...
                    .expect =
                        Registers{.bx = 0x80, .si = 0x04, .ip = 3, .es = 0x1234},
                    .expect_memory = MemoryOp{.address = 0x85, .data = {0x34, 0x12}},
                    .cycles        = 0x14,
                }),
                add({
                    .cmd  = {0x8e, 0x41, 0x10},
                    ...
                    .expect =
                        Registers{.bx = 0x80, .di = 0x04, .ip = 3, .es = 0x1234},
                    .expect_memory = MemoryOp{.address = 0x94, .data = {0x34, 0x12}},
                    .cycles        = 0x15,
                }),
                add({
                    .cmd  = {0x8e, 0x42, 0x10},
                ...
                add({
                    ...
                    .expect_memory = MemoryOp{.address = 0x811, .data = {0x34, 0x12}},
                    .cycles        = 0x12,
                }),
                add({
                    .cmd  = {0x8e, 0x47, 0x10}, 
                ...
                add({
                    ...
                    .expect =
                        Registers{.bx = 0x80, .si = 0x04, .ip = 4, .es = 0x1234},
                    .expect_memory = MemoryOp{.address = 0x1085, .data = {0x34, 0x12}},
                    .cycles        = 0x14,
                }),
                add({
                    ...
                    .expect =
                        Registers{.bx = 0x80, .di = 0x04, .ip = 4, .es = 0x1234},
                    .expect_memory = MemoryOp{.address = 0x1094, .data = {0x34, 0x12}},
                    .cycles        = 0x15,
                }),
                add({
                ...
                add({
                    ...
                    .expect_memory = MemoryOp{.address = 0x1811, .data = {0x34, 0x12}},
                    .cycles        = 0x12,
                }),
                add({
