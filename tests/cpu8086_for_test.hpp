...
class Cpu8086ForTest : public Cpu8086
{
public:
    using Cpu8086::Cpu8086;
    const Cpu8086::Registers& get_registers() const;
    Cpu8086::Registers& get_registers();
};

inline bool operator==(const Cpu8086::Registers& lhs, const Cpu8086::Registers& rhs)
{
...
inline void PrintTo(const Cpu8086::Registers& reg, ::std::ostream* os)
{
    *os << std::endl;
    char line[255];
