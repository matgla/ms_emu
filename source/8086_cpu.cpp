...
//
// template <typename T>
// void print_table_row(std::size_t columns, size_t size, const T& data, bool newline =
// true)
// {
...
//         case 0x8e:
//         {
//             snprintf(line, max_size, "mov %s,%s", sreg_mapping[get_reg_op(data[0]) &
//             0x3],
...
//     if (size == 2)
//     {
//         snprintf(line, max_size, " %c %8lx: %02x %02x     | %s", cursor,
//         program_counter,
//                  pc, data[0], command);
//     }
//     if (size == 3)
